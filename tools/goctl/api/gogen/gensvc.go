...
import (
	...
	"github.com/chinashuguo/go-zero/tools/goctl/api/spec"
	"github.com/chinashuguo/go-zero/tools/goctl/api/util"
	"github.com/chinashuguo/go-zero/tools/goctl/config"
	ctlutil "github.com/chinashuguo/go-zero/tools/goctl/util"
	"github.com/chinashuguo/go-zero/tools/goctl/util/format"
	"github.com/chinashuguo/go-zero/tools/goctl/vars"
)
