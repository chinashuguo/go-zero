...
import (
	...
	"github.com/chinashuguo/go-zero/core/logx"
	"github.com/chinashuguo/go-zero/tools/goctl/api/apigen"
	"github.com/chinashuguo/go-zero/tools/goctl/api/dartgen"
	"github.com/chinashuguo/go-zero/tools/goctl/api/docgen"
	"github.com/chinashuguo/go-zero/tools/goctl/api/format"
	"github.com/chinashuguo/go-zero/tools/goctl/api/gogen"
	"github.com/chinashuguo/go-zero/tools/goctl/api/javagen"
	"github.com/chinashuguo/go-zero/tools/goctl/api/ktgen"
	"github.com/chinashuguo/go-zero/tools/goctl/api/new"
	"github.com/chinashuguo/go-zero/tools/goctl/api/tsgen"
	"github.com/chinashuguo/go-zero/tools/goctl/api/validate"
	"github.com/chinashuguo/go-zero/tools/goctl/configgen"
	"github.com/chinashuguo/go-zero/tools/goctl/docker"
	"github.com/chinashuguo/go-zero/tools/goctl/kube"
	model "github.com/chinashuguo/go-zero/tools/goctl/model/sql/command"
	"github.com/chinashuguo/go-zero/tools/goctl/plugin"
	rpc "github.com/chinashuguo/go-zero/tools/goctl/rpc/cli"
	"github.com/chinashuguo/go-zero/tools/goctl/tpl"
			...
			Subcommands: []cli.Command{
				...
				},
				{
					...
					Flags: []cli.Flag{
						...
						cli.StringFlag{
							Name:  "style",
							Usage: "the file naming format, see [https://github.com/chinashuguo/go-zero/tree/master/tools/goctl/config/readme.md]",
						},
					},
